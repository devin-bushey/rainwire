...
export const extract_vic_songkick_3 = async () => {
  console.log('Extracting song kick 3');
  let data: any[] = [];

  await get({
    url: 'https://www.songkick.com/metro-areas/27399-canada-victoria?page=3#metro-area-calendar'
  })
  .then((response: any) => {
  ...
  .catch((error: any) => {
    console.log(error);
    console.log('Error extracting songkick3');
  });
