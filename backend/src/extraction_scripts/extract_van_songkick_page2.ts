...
export const extract_van_songkick_2 = async () => {
  console.log('Extracting song kick 2');
  let data: any[] = [];

  await get({
    url: 'https://www.songkick.com/metro-areas/27398-canada-vancouver?page=2#metro-area-calendar',
  })
    .then((response: any) => {
    ...
    .catch((error: any) => {
      console.log(error);
      console.log('Error extracting songkick 2');
    });
