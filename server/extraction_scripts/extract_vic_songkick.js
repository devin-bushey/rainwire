    ...
    extract: function () {
        ...
        return new Promise(async function (resolve, reject) {
            try {
                ...
                const html = await axios.get('https://www.songkick.com/metro-areas/27399-canada-victoria?page=1#metro-area-calendar');
                ...
                resolve(data);
                console.log("Successfully extracted Victoria SongKick Page 01");

            }
            catch (err) {
                reject("error: Victoria SongKick Page 01 extraction")
                console.log("error: Victoria SongKick Page 01 extraction");
            }
